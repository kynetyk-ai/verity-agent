...
def main():
    ...
    try:
        ...
        xgb_cfgs = [
            ...
            dict(n_estimators=700, max_depth=5, learning_rate=0.050, subsample=0.88,
                 colsample_bytree=0.92, min_child_weight=14, reg_lambda=4.0,
                 reg_alpha=0.10, random_state=73),
        ]
    ...
    mult_map = {"GALAXY": 0.86, "QSO": 1.17, "STAR": 1.23}
