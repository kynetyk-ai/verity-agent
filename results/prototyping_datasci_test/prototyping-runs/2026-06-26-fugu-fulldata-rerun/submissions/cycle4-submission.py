...
def main():
    ...
    try:
        ...
        lgb_cfgs = [
            ...
            # A shallower/faster LightGBM variant improves minority-class balance on held-out splits.
            dict(n_estimators=650, learning_rate=0.060, num_leaves=48, max_depth=-1,
                 min_child_samples=90, subsample=0.95, colsample_bytree=0.95,
                 reg_lambda=1.5, reg_alpha=0.0, random_state=909),
        ]
    ...
    base_weights = {
        "lgb1": 1.20, "lgb2": 1.02, "lgb3": 0.72,
        "xgb1": 1.85, "xgb2": 1.22, "xgb3": 0.64,
        "hgb": 0.22,
    }
    ...
    mult_map = {"GALAXY": 0.70, "QSO": 1.00, "STAR": 1.05}
