"""The user-side fe-kaggle trajectory readout (``feature-engineering-test/trajectory.py``).
...
_SCRIPT = Path(__file__).resolve().parents[1] / "feature-engineering-test" / "trajectory.py"
